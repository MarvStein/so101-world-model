...
train_datasets: dict[str, Dataset_] = {
    ...
    "lerobot-so101": L(Dataset)(
        dataset_dir="/home/ubuntu/workspace/so101-world-model/data/lerobot", # Base path to the dataset directory containing subdirectories for video files and t5 embeddings
